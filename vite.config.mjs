...
const pageInputs = {
  ...
  purchaseContractArticle: resolve("artigos/contrato-compra-venda-imovel-cuidados/index.html"),
  usucapiaoArticle: resolve("artigos/usucapiao-regularizacao-imovel/index.html"),
  justCauseCompanyArticle: resolve("artigos/demissao-por-justa-causa-empresa/index.html"),
  cellphoneWorkArticle: resolve("artigos/empresa-pode-proibir-celular-trabalho/index.html"),
...
const pageRoutes = new Map([
  ...
  [pageInputs.purchaseContractArticle, "/artigos/contrato-compra-venda-imovel-cuidados"],
  [pageInputs.usucapiaoArticle, "/artigos/usucapiao-regularizacao-imovel"],
  [pageInputs.justCauseCompanyArticle, "/artigos/demissao-por-justa-causa-empresa"],
  [pageInputs.cellphoneWorkArticle, "/artigos/empresa-pode-proibir-celular-trabalho"],
...
const routeImages = new Map([
  ...
  ["/artigos/contrato-compra-venda-imovel-cuidados", "/artigos/artigo-imobiliario.jpg"],
  ["/artigos/usucapiao-regularizacao-imovel", "/artigos/artigo-imobiliario.jpg"],
  ["/artigos/demissao-por-justa-causa-empresa", "/home-detalhe-documentos.jpg"],
  ["/artigos/empresa-pode-proibir-celular-trabalho", "/home-detalhe-documentos.jpg"],
